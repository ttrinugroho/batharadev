...
var hotroute_1 = __webpack_require__(756);
(function () {
    document.addEventListener('DOMContentLoaded', function (e) {
        var router = hotroute_1.default({ log: true });
        var ifExists = function (el, style, val) {
            if (el) {
                el.style[style] = val;
            }
        };
        var isSmall = function () { return window.innerWidth <= 768; };
        var $ = function (selector) { return window.document.querySelector(selector); };
        var attri = window.document.querySelector('body');
        ...
        $('#chang-theme').addEventListener('click', function (e) {
            console.log('clicked');
        ...
        // text
        window.addEventListener('router:end', function (e) {
            var page_path = new URL(window.history.state['url']).pathname;
            gtag('config', 'UA-59099331-16', { page_path: page_path });
        });
    });
})();
